...
var ViewsHelpers__jq$, ViewsHelpers__isFSharpEditor$, UnfoldEnumerator_2_Int32__String_____ctor$Int32_String___, UnfoldEnumerator_2_Int32__Disposable___ctor$Int32_Disposable_, TupleString____Int32, TupleDisposable__Int32, String__StartsWith$, String__SplitWithoutOptions$, String__Replace$, String__PrintFormatToString$, String__EndsWith$, Seq__Unfold$Int32__String___Int32_String___, Seq__Unfold$Int32__Disposable_Int32_Disposable_, Seq__ToArray$String___String___, Seq__OfArray$String___String___, Seq__IterateIndexed$String___String___, Seq__Iterate$Disposable_Disposable_, Seq__FromFactory$String___String___, Seq__FromFactory$Disposable_Disposable_, Seq__FoldIndexedAux$Unit__String___Unit__String___, Seq__FoldIndexedAux$Unit__Disposable_Unit__Disposable_, Seq__FoldIndexed$String____Unit_String____Unit_, Seq__FoldIndexed$Disposable__Unit_Disposable__Unit_, Seq__Fold$Disposable__Unit_Disposable__Unit_, Seq__Enumerator$String___String___, Seq__Enumerator$Disposable_Disposable_, ResizeArray__ToSeq$Disposable_Disposable_, ResizeArray_1_Object__get_Item$Object_, ResizeArray_1_Object__get_Count$Object_, Process__spawnSame$, Process__isWin$, Process__getCwd$, Options___ctor$, Option__Iterate$IPanel_IPanel_, Option__Iterate$ChildProcess_ChildProcess_, Option__IsSome$Int32_Int32, Option__IsSome$IPanel_IPanel_, Option__IsSome$ChildProcess_ChildProcess_, Option__IsNone$ChildProcess_ChildProcess_, Option__GetValue$Tuple_2_String____Int32_Tuple_2_String____Int32_, Option__GetValue$Tuple_2_Disposable__Int32_Tuple_2_Disposable__Int32_, Option__GetValue$Int32_Int32, Option__GetValue$IPanel_IPanel_, Option__GetValue$ChildProcess_ChildProcess_, OpenEditorOptions___ctor$, Fsi__deactivate$, Fsi__activate$, Fsi___ctor$, FsiView__insert$, FsiView__clear$, FsiService__subscriptions, FsiService__startFsi$, FsiService__sendToFsi$, FsiService__sendSelection$, FsiService__sendLine$, FsiService__sendFile$, FsiService__resetFsi$, FsiService__opener$, FsiService__openFsi$, FsiService__handle$, FsiService__get_subscriptions$, FsiService__get_fsipath$, FsiService__get_fsiProc$, FsiService__get_fsiEditor$, FsiService__fsipath, FsiService__fsiProc, FsiService__fsiEditor, FsiService__deactivate$, FsiService__activate$, CreateEnumerable_1_String_____ctor$String___, CreateEnumerable_1_Disposable___ctor$Disposable_, Array__ZeroCreate$String___String___, Array__MapIndexed$String_1_String___String_String___, Array__Map$String_1_String___String_String___, Array__Length$String_1String, Array__Iterate$String_1String, Array__FoldIndexed$Unit__String_1Unit__String, Array__FoldIndexed$String____String_1String____String, Array__Fold$String_1_Unit_String_Unit_, Array__Fold$String_1_String___String_String___, Array__ConcatImpl$String_1String, Array__Concat$String_1String, Array__BoxedLength$;
...
Array__Fold$String_1_Unit_String_Unit_ = (function(f,seed,xs)
{
    return Array__FoldIndexed$Unit__String_1Unit__String((function(_arg1)
    {
      return (function(acc)
      {
        return (function(x)
...
Array__FoldIndexed$Unit__String_1Unit__String = (function(f,seed,xs)
{
    var acc = seed;
    for (var i = 0; i <= (Array__Length$String_1String(xs) - 1); i++)
    {
...
Array__Iterate$String_1String = (function(f,xs)
{
    var _521;
    return Array__Fold$String_1_Unit_String_Unit_((function(unitVar0)
    {
      return (function(x)
      {
        return f(x);
...
FsiService__handle$ = (function(data)
{
    if ((data != null)) 
    {
      ...
      return Option__Iterate$IPanel_IPanel_((function(_arg1)
      {
        return FsiView__insert$(response);
...
FsiService__opener$ = (function(uri)
{
    try
    {
...
FsiService__resetFsi$ = (function(unitVar0)
{
    ...
    if (Option__IsSome$IPanel_IPanel_(FsiService__fsiEditor)) 
    {
      FsiService__startFsi$();
      return FsiView__clear$();
    }
    else
    {
      ;
...
FsiService__sendToFsi$ = (function(msg_)
{
    ...
    Option__Iterate$IPanel_IPanel_((function(ed)
    {
      if ((!((((window.atom).views).getView(ed)) != undefined))) 
      {
        return FsiService__openFsi$();
      }
      else
    ...
    if (ViewsHelpers__isFSharpEditor$(editor)) 
    {
      ...
      return Option__Iterate$ChildProcess_ChildProcess_((function(cproc)
      {
        try
        {
          ...
          var clo1 = String__PrintFormatToString$("# silentCd @\"%s\" ;; ");
          var _clo1 = String__PrintFormatToString$("# %d @\"%s\" ");
          var cd = (((("\n" + (function(arg10)
          {
            return clo1(arg10);
          })(dir)) + "\n") + (function(arg10)
...
{
    var fs = Process__spawnSame$(FsiService__fsipath, "--fsi-server-input-codepage:65001");
...
FsiView__clear$ = (function(unitVar0)
{
    var fsi = ViewsHelpers__jq$(".fsi");
    var ignored0 = (fsi.empty());
});
FsiView__insert$ = (function(str)
{
    var fsi = ViewsHelpers__jq$(".fsi");
    return Array__Iterate$String_1String((function(s)
    {
      if ((!(s==null)||(s==""))) 
      {
        var clo1 = String__PrintFormatToString$("\u003cpre class=\u0027fsi-row\u0027\u003e%s\u003c/pre\u003e");
        var r = (function(arg10)
        {
          return clo1(arg10);
        })(s);
        var ignored0 = (fsi.append(r));
        var _ignored0 = (fsi.scrollTop(99999999.000000));
      }
      else
      {
        ;
      };
    }), String__SplitWithoutOptions$(str, ["\n"]));
});
...
Option__IsSome$IPanel_IPanel_ = (function(option)
{
    return ((option.Tag == 1.000000) && true);
});
