...
AsyncBuilder__While$ = (function(x,cond,body)
{
    ...
    {
      var _2070;
      return AsyncBuilder__Return$Unit_Unit_(x, _2070);
    };
});
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _1558;
      return Async__invokeCont$Unit_Unit_(k, _1558);
    }));
});
...
Async_1_StartImmediate$ = (function(workflow,cancellationToken)
{
    ...
    {
      _2073 = (new CancellationToken___ctor$({Tag: 0.000000}));
    };
    var token = _2073;
    var f = workflow.Item;
...
Fsi_1_appendErrors$ = (function(errors)
{
    ...
    else
    {
      ...
      for (var _3769 = 0; _3769 <= (Array__Length$TypeCheckError_TypeCheckError_(errors) - 1); _3769++)
      {
        (function(idx)
        {
          var err = errors[idx];
...
Fsi_1_appendFsiHtmlPanel$ = (function(id,expanded,html)
{
    ...
    if (expanded) 
    {
      _3830 = "icon-chevron-down";
    }
    else
    {
      _3830 = "icon-chevron-right";
    };
    var icon = (ViewsHelpers__jq$("\u003cspan /\u003e").addClass(("icon " + _3830)));
...
Fsi_1_appendFsiPanel$ = (function(cssclass,expanded,input)
{
    ...
    var pre = (ViewsHelpers__jq$("\u003cpre /\u003e").text(_1914));
    var _1921;
    if (expanded) 
    {
      _1921 = "icon-chevron-down";
    }
    else
    {
      _1921 = "icon-chevron-right";
    };
    var icon = (ViewsHelpers__jq$("\u003cspan /\u003e").addClass(("icon " + _1921)));
    ...
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      }), AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
      {
        ...
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _667, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(__unitVar)
        {
          ...
          {
            var _2025;
            return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _2025);
          }));
        })));
      })));
    }));
...
Fsi_1_navigateToEditor$ = (function(file,line,col)
{
    ...
    for (var _3758 = 0; _3758 <= (Array__Length$IPane_IPane_(arr) - 1); _3758++)
    {
      (function(idx)
      {
        var pane = arr[idx];
        var _arr = (pane.getItems());
        for (var _3757 = 0; _3757 <= (Array__Length$Object_Object_(_arr) - 1); _3757++)
        {
          (function(_idx)
          {
            var item = _arr[_idx];
...
Fsi_1_trimEnd$ = (function(suffix,text)
{
    ...
    {
      _1875 = _text.substring(0, 0 + (_text.length - suffix.length));
    }
    else
    {
      _1875 = _text;
    ...
    return AsyncBuilder__Delay$String_1String(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$Result_1_Unit__String_1Result_1_Unit__String(Async__get_async$(), InteractiveServer__request$Result_1_Unit_Result_1_Unit_(InteractiveServer__url$("output"), {Tag: 0.000000}), (function(_arg1)
      {
        ...
        if ((res.result != "output")) 
        {
          ...
          _1544 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _1544 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$String_1String(Async__get_async$(), _1544, AsyncBuilder__Delay$String_1String(Async__get_async$(), (function(_unitVar)
        {
...
InteractiveServer__request$Result_1_Unit_Result_1_Unit_ = (function(url,data)
{
    return AsyncBuilder__Delay$Result_1_Unit_Result_1_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      })), (function(_arg2)
      {
        ...
        throw (("Parsing response failed: " + msg));
...
Seq__Delay$IEnumerable_1_Tuple_2_IPane__Object_IEnumerable_1_Tuple_2_IPane__Object_ = (function(f)
{
    ...
    {
      var _2448;
      return Seq__Enumerator$IEnumerable_1_Tuple_2_IPane__Object_IEnumerable_1_Tuple_2_IPane__Object_(f(_2448));
    }));
});
Seq__Delay$Tuple_2_IPane__Object_Tuple_2_IPane__Object_ = (function(f)
{
    ...
    {
      var _2595;
      return Seq__Enumerator$Tuple_2_IPane__Object_Tuple_2_IPane__Object_(f(_2595));
    }));
});
