...
Fsi_1_appendErrors$ = (function(errors)
{
    ...
    else
    {
      ...
      for (var _3801 = 0; _3801 <= (Array__Length$TypeCheckError_TypeCheckError_(errors) - 1); _3801++)
      {
        (function(idx)
        {
          var err = errors[idx];
...
Fsi_1_appendFsiHtmlPanel$ = (function(expanded,res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      if ((!needsIframe)) 
      {
        _3963 = AsyncBuilder__Delay$JQuery_JQuery_(Async__get_async$(), (function(_unitVar)
        {
      ...
      return AsyncBuilder__Bind$JQuery__Unit_JQuery__Unit_(Async__get_async$(), _3963, (function(_arg3)
      {
        var html = _arg3;
        var _4375;
        if (expanded) 
        {
          _4375 = "icon-chevron-down";
        }
        else
        {
          _4375 = "icon-chevron-right";
        };
        var icon = (ViewsHelpers__jq$("\u003cspan /\u003e").addClass(("icon " + _4375)));
...
Fsi_1_appendFsiResult$ = (function(res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      if ((res.Tag == 1.000000)) 
      {
        ...
        _3611 = AsyncBuilder__Zero$(Async__get_async$());
      }
      else
      {
        if ((res.Tag == 2.000000)) 
        {
          ...
          {
            _3611 = AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), Fsi_1_appendFsiHtmlPanel$(true, succ.details.html), (function(_arg1)
            {
              var _4453;
              return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4453);
            }));
          }
          else
          {
      ...
      return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _3611, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
      {
...
Fsi_1_navigateToEditor$ = (function(file,line,col)
{
    ...
    for (var _3790 = 0; _3790 <= (Array__Length$IPane_IPane_(arr) - 1); _3790++)
    {
      (function(idx)
      {
        var pane = arr[idx];
        var _arr = (pane.getItems());
        for (var _3789 = 0; _3789 <= (Array__Length$Object_Object_(_arr) - 1); _3789++)
        {
          (function(_idx)
          {
            var item = _arr[_idx];
