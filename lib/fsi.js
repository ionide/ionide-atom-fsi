...
AsyncBuilder__While$ = (function(x,cond,body)
{
    ...
    {
      var _2076;
      return AsyncBuilder__Return$Unit_Unit_(x, _2076);
    };
});
...
Async_1_StartImmediate$ = (function(workflow,cancellationToken)
{
    ...
    {
      _2079 = (new CancellationToken___ctor$({Tag: 0.000000}));
    };
    var token = _2079;
    var f = workflow.Item;
...
Fsi_1_appendErrors$ = (function(errors)
{
    ...
    else
    {
      ...
      for (var _3805 = 0; _3805 <= (Array__Length$TypeCheckError_TypeCheckError_(errors) - 1); _3805++)
      {
        (function(idx)
        {
          var err = errors[idx];
...
Fsi_1_appendFsiHtmlPanel$ = (function(expanded,res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      if ((!needsIframe)) 
      {
        _3967 = AsyncBuilder__Delay$JQuery_JQuery_(Async__get_async$(), (function(_unitVar)
        {
      ...
      return AsyncBuilder__Bind$JQuery__Unit_JQuery__Unit_(Async__get_async$(), _3967, (function(_arg3)
      {
        var html = _arg3;
        var _4379;
        if (expanded) 
        {
          _4379 = "icon-chevron-down";
        }
        else
        {
          _4379 = "icon-chevron-right";
        };
        var icon = (ViewsHelpers__jq$("\u003cspan /\u003e").addClass(("icon " + _4379)));
...
Fsi_1_appendFsiResult$ = (function(res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      if ((res.Tag == 1.000000)) 
      {
        ...
        _3615 = AsyncBuilder__Zero$(Async__get_async$());
      }
      else
      {
        if ((res.Tag == 2.000000)) 
        {
          ...
          {
            _3615 = AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), Fsi_1_appendFsiHtmlPanel$(true, succ.details.html), (function(_arg1)
            {
              var _4457;
              return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4457);
            }));
          }
          else
          {
      ...
      return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _3615, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
      {
    ...
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      }), AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
      {
        ...
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _667, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(__unitVar)
        {
          ...
          {
            var _2031;
            return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _2031);
          }));
        })));
      })));
    }));
...
Fsi_1_navigateToEditor$ = (function(file,line,col)
{
    ...
    for (var _3794 = 0; _3794 <= (Array__Length$IPane_IPane_(arr) - 1); _3794++)
    {
      (function(idx)
      {
        var pane = arr[idx];
        var _arr = (pane.getItems());
        for (var _3793 = 0; _3793 <= (Array__Length$Object_Object_(_arr) - 1); _3793++)
        {
          (function(_idx)
          {
            var item = _arr[_idx];
      ...
      if (ViewsHelpers__isFSharpEditor$(editor)) 
      {
        ...
        return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), Fsi_1_openFsiPane$(), (function(_arg1)
        {
          ...
          return AsyncBuilder__Bind$EvaluationResult__Unit_EvaluationResult__Unit_(Async__get_async$(), InteractiveServer__eval$((editor.getPath()), line, code), (function(_arg2)
          {
            ...
            {
              var _4485;
              return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4485);
            }));
          }));
        }));
      }
...
InteractiveServer__charCodeAt$ = (function(s,i)
{
...
InteractiveServer__eval$ = (function(file,line,code)
{
    ...
    {
      var _3390;
      if ((InteractiveServer__charCodeAt$(code, 0) == 65279)) 
      {
        _3390 = code.substring(1);
      }
      else
      {
        _3390 = code;
      ...
      var _code = _3390;
      return AsyncBuilder__Bind$Result_1_Unit__EvaluationResult_Result_1_Unit__EvaluationResult_(Async__get_async$(), InteractiveServer__request$Result_1_Unit_Result_1_Unit_(InteractiveServer__url$("eval"), {Tag: 1.000000, Value: (new EvalRequest___ctor$(file, line, _code))}), (function(_arg1)
      {
        var result = _arg1;
...
Seq__Delay$IEnumerable_1_Tuple_2_IPane__Object_IEnumerable_1_Tuple_2_IPane__Object_ = (function(f)
{
    ...
    {
      var _2454;
      return Seq__Enumerator$IEnumerable_1_Tuple_2_IPane__Object_IEnumerable_1_Tuple_2_IPane__Object_(f(_2454));
    }));
});
Seq__Delay$Tuple_2_IPane__Object_Tuple_2_IPane__Object_ = (function(f)
{
    ...
    {
      var _2601;
      return Seq__Enumerator$Tuple_2_IPane__Object_Tuple_2_IPane__Object_(f(_2601));
    }));
});
