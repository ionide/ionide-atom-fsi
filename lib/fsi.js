...
Fsi_1_appendErrors$ = (function(errors)
{
    ...
    else
    {
      ...
      for (var _3829 = 0; _3829 <= (Array__Length$TypeCheckError_TypeCheckError_(errors) - 1); _3829++)
      {
        (function(idx)
        {
          var err = errors[idx];
...
Fsi_1_appendFsiHtmlPanel$ = (function(expanded,res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      if ((!needsIframe)) 
      {
        _3991 = AsyncBuilder__Delay$JQuery_JQuery_(Async__get_async$(), (function(_unitVar)
        {
      ...
      return AsyncBuilder__Bind$JQuery__Unit_JQuery__Unit_(Async__get_async$(), _3991, (function(_arg3)
      {
        var html = _arg3;
        var _4403;
        if (expanded) 
        {
          _4403 = "icon-chevron-down";
        }
        else
        {
          _4403 = "icon-chevron-right";
        };
        var icon = (ViewsHelpers__jq$("\u003cspan /\u003e").addClass(("icon " + _4403)));
...
Fsi_1_appendFsiResult$ = (function(res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      if ((res.Tag == 1.000000)) 
      {
        ...
        _3639 = AsyncBuilder__Zero$(Async__get_async$());
      }
      else
      {
        if ((res.Tag == 2.000000)) 
        {
          ...
          {
            _3639 = AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), Fsi_1_appendFsiHtmlPanel$(true, succ.details.html), (function(_arg1)
            {
              var _4481;
              return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4481);
            }));
          }
          else
          {
      ...
      return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _3639, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
      {
...
Fsi_1_navigateToEditor$ = (function(file,line,col)
{
    ...
    for (var _3818 = 0; _3818 <= (Array__Length$IPane_IPane_(arr) - 1); _3818++)
    {
      (function(idx)
      {
        var pane = arr[idx];
        var _arr = (pane.getItems());
        for (var _3817 = 0; _3817 <= (Array__Length$Object_Object_(_arr) - 1); _3817++)
        {
          (function(_idx)
          {
            var item = _arr[_idx];
      ...
      if (ViewsHelpers__isFSharpEditor$(editor)) 
      {
        ...
        return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), Fsi_1_openFsiPane$(), (function(_arg1)
        {
          ...
          return AsyncBuilder__Bind$EvaluationResult__Unit_EvaluationResult__Unit_(Async__get_async$(), InteractiveServer__eval$((editor.getPath()), line, code), (function(_arg2)
          {
            ...
            {
              var _4509;
              return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4509);
            }));
          }));
        }));
      }
