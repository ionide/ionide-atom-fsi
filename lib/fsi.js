...
AsyncBuilder__While$ = (function(x,cond,body)
{
    ...
    {
      var _2106;
      return AsyncBuilder__Return$Unit_Unit_(x, _2106);
    };
});
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _1594;
      return Async__invokeCont$Unit_Unit_(k, _1594);
    }));
});
...
Async_1_StartImmediate$ = (function(workflow,cancellationToken)
{
    ...
    {
      _2109 = (new CancellationToken___ctor$({Tag: 0.000000}));
    };
    var token = _2109;
    var f = workflow.Item;
...
Fsi_1_appendErrors$ = (function(errors)
{
    ...
    else
    {
      ...
      for (var _3813 = 0; _3813 <= (Array__Length$TypeCheckError_TypeCheckError_(errors) - 1); _3813++)
      {
        (function(idx)
        {
          var err = errors[idx];
...
Fsi_1_appendFsiHtmlPanel$ = (function(id,expanded,html)
{
    var pre = ((ViewsHelpers__jq$("\u003cpre /\u003e").text("(...)")).hide());
    var _html = ((ViewsHelpers__jq$("\u003cdiv /\u003e").addClass("content")).html(html));
    var _3874;
    if (expanded) 
    {
      _3874 = "icon-chevron-down";
    }
    else
    {
      _3874 = "icon-chevron-right";
    };
    var icon = (ViewsHelpers__jq$("\u003cspan /\u003e").addClass(("icon " + _3874)));
    var padding = (((ViewsHelpers__jq$("\u003cdiv class=\u0027inset-panel padded\u0027/\u003e").append(icon)).append(pre)).append(_html));
...
Fsi_1_appendFsiPanel$ = (function(cssclass,expanded,input)
{
    ...
    var pre = (ViewsHelpers__jq$("\u003cpre /\u003e").text(_1950));
    var _1957;
    if (expanded) 
    {
      _1957 = "icon-chevron-down";
    }
    else
    {
      _1957 = "icon-chevron-right";
    };
    var icon = (ViewsHelpers__jq$("\u003cspan /\u003e").addClass(("icon " + _1957)));
    ...
    else
    {
      if ((res.Tag == 2.000000)) 
      {
        ...
        if ((succ.details.html != null)) 
        {
          ...
          Fsi_1_appendFsiHtmlPanel$(id, true, succ.details.html);
          var style = (ViewsHelpers__jq$("style[source-path*=\u0027fsi.less\u0027]").text());
          var _style = (("\u003cstyle type=\u0027text/css\u0027\u003e" + style) + "\u003c/style\u003e");
          var ignored0 = (ViewsHelpers__jq$((("#" + id) + " iframe")).each((function(_arg2,frame)
          {
            var _frame = frame;
            return (_frame.addEventListener("load", (function(_arg1)
            {
              return (ViewsHelpers__jq_$(((_frame.contentDocument).body)).append(_style));
            })));
          })));
        }
        else
    ...
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      }), AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
      {
        ...
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _667, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(__unitVar)
        {
          ...
          {
            var _2061;
            return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _2061);
          }));
        })));
      })));
    }));
...
Fsi_1_navigateToEditor$ = (function(file,line,col)
{
    ...
    for (var _3802 = 0; _3802 <= (Array__Length$IPane_IPane_(arr) - 1); _3802++)
    {
      (function(idx)
      {
        var pane = arr[idx];
        var _arr = (pane.getItems());
        for (var _3801 = 0; _3801 <= (Array__Length$Object_Object_(_arr) - 1); _3801++)
        {
          (function(_idx)
          {
            var item = _arr[_idx];
          ...
          if ((List__Tail$String_1String(data).Tag == 1.000000)) 
          {
            if ((List__Tail$String_1String(List__Tail$String_1String(data)).Tag == 1.000000)) 
            {
              if ((List__Tail$String_1String(List__Tail$String_1String(List__Tail$String_1String(data))).Tag == 0.000000)) 
              {
                ...
                var _hgt = _3131;
                var ignored0 = (ViewsHelpers__jq$(("#" + id)).height((_hgt.toString() + "px")));
                var _ignored0 = (ViewsHelpers__jq$(".fsi").scrollTop(99999999.000000));
              }
              else
              {
...
Fsi_1_trimEnd$ = (function(suffix,text)
{
    ...
    {
      _1911 = _text.substring(0, 0 + (_text.length - suffix.length));
    }
    else
    {
      _1911 = _text;
...
InteractiveServer__cancel$ = (function(unitVar0)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      {
        var res = _arg1;
        if (((Result_1_Unit__GeneratedCompareToUnit_(res)(null) == 0) || (res.result != "cancel"))) 
        {
...
InteractiveServer__output$ = (function(unitVar0)
{
    return AsyncBuilder__Delay$String_1String(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$Result_1_Unit__String_1Result_1_Unit__String(Async__get_async$(), InteractiveServer__request$Result_1_Unit_Result_1_Unit_(InteractiveServer__url$("output"), {Tag: 0.000000}), (function(_arg1)
      {
        var res = _arg1;
        var _1542;
        if (((Result_1_Unit__GeneratedCompareToUnit_(res)(null) == 0) || (res.result != "output"))) 
        {
...
Result_1_Unit__GeneratedCompareToUnit_ = (function(a)
{
    return (function(b)
    {
      var diff = (a.result < b.result ? -1 : (a.result == b.result ? 0 : 1));
      if ((diff != 0)) 
      {
        return diff;
      }
      ...
      {
        var _diff = (a.output < b.output ? -1 : (a.output == b.output ? 0 : 1));
        if ((_diff != 0)) 
        {
          return _diff;
        }
        ...
        {
          var __diff = (a.details < b.details ? -1 : (a.details == b.details ? 0 : 1));
          if ((__diff != 0)) 
          {
            return __diff;
          }
...
Seq__Delay$IEnumerable_1_Tuple_2_IPane__Object_IEnumerable_1_Tuple_2_IPane__Object_ = (function(f)
{
    ...
    {
      var _2484;
      return Seq__Enumerator$IEnumerable_1_Tuple_2_IPane__Object_IEnumerable_1_Tuple_2_IPane__Object_(f(_2484));
    }));
});
Seq__Delay$Tuple_2_IPane__Object_Tuple_2_IPane__Object_ = (function(f)
{
    ...
    {
      var _2631;
      return Seq__Enumerator$Tuple_2_IPane__Object_Tuple_2_IPane__Object_(f(_2631));
    }));
});
